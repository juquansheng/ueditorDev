...
public class ImageHunter {
    ...
    public ImageHunter(Map<String, Object> conf) {
        ...
        this.defaultUpload = (Boolean) conf.get("defaultUpload");
        this.proxyPath = conf.get("proxyPath").toString();
    }
    ...
    public State captureRemoteData(String urlStr) {
        ...
        try {
            ...
            if (defaultUpload) {
                ...
                Class clazz;
                try {
                    clazz = Class.forName(proxyPath);
                    Method m = clazz.getMethod("saveFileByInputStream", InputStream.class, String.class, long.class);
                    state = (State) m.invoke(clazz.newInstance(), connection.getInputStream(), savePath, maxSize);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
